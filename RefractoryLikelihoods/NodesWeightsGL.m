function [x w neval]=NodesWeightsGL(varargin)
...
load nodesweightsGL
nmax=size(weights,2);
%Maximum of Gauss-Lobatto nodes to be used in each integral.
%nmax=300 by default. To try different values create a different
%set of nodes and weights and save it to the file nodesweightsGL.mat
